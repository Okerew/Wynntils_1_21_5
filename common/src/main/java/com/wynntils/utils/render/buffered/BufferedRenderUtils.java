...
public final class BufferedRenderUtils {
    public static void drawLine(
        ...
        //            }
        //
        //            buffer.addVertex(matrix, x1 + halfWidth, y1 - halfWidth, z).setColor(color.r, color.g, color.b,
        // color.a);
        //            buffer.addVertex(matrix, x1 - halfWidth, y1 + halfWidth, z).setColor(color.r, color.g, color.b,
        // color.a);
        //            buffer.addVertex(matrix, x2 + halfWidth, y2 - halfWidth, z).setColor(color.r, color.g, color.b,
        // color.a);
        //            buffer.addVertex(matrix, x2 - halfWidth, y2 + halfWidth, z).setColor(color.r, color.g, color.b,
        // color.a);
    ...
    public static void drawColoredTexturedRect(
        ...
        //                .setUv(1, 0)
        //                .setColor(colorArray[0], colorArray[1], colorArray[2], alpha);
        //        buffer.addVertex(matrix, x, y, z).setUv(0, 0).setColor(colorArray[0], colorArray[1], colorArray[2],
        // alpha);
    }
    ...
    public static void drawTexturedRect(
        ...
        //        buffer.addVertex(matrix, x + width, y + height, z).setUv((uOffset + u) * uScale, (vOffset + v) *
        // vScale);
    ...
    public static void drawProgressBarForeground(
        ...
        //
        //        VertexConsumer buffer =
        // bufferSource.getBuffer(CustomRenderType.getPositionTextureQuad(texture.resource()));
        //
        //        float xMin = Math.min(x1, x2),
        //                xMax = Math.max(x1, x2),
        //                yMin = Math.min(y1, y2),
