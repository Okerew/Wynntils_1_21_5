...
public class RatingRewardsContainer extends Container implements ScrollableContainerProperty {
    private static final Pattern TITLE_PATTERN = Pattern.compile("Rating Rewards");
